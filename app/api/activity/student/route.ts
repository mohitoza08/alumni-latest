...
export async function GET(req: NextRequest) {
  try {
    ...
    console.log("[v0] Student activity - user:", user?.id)
    ...
    try {
      ...
      for (const req of mentorshipRequests || []) {
        activities.push({
          ...
          type: "mentorship",
          title: `Request to ${req.mentor_first_name} ${req.mentor_last_name}`,
    ...
    try {
      ...
      console.log("[v0] Events query error:", e)
    }
    ...
    console.error("[v0] Student activity error:", error)
